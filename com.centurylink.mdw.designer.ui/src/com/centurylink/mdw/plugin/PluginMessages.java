...
public class PluginMessages {
    public static Map<Integer, String> MESSAGE_LEVELS = new HashMap<>();
    ...
    static {
        MESSAGE_LEVELS.put(INFO_MESSAGE, "Info");
        MESSAGE_LEVELS.put(CONNECTION_MESSAGE, "Connection");
        MESSAGE_LEVELS.put(DATA_INTEGRITY_MESSAGE, "Data Integrity");
        MESSAGE_LEVELS.put(VALIDATION_MESSAGE, "Validation");
        MESSAGE_LEVELS.put(WARNING_MESSAGE, "Warning");
        MESSAGE_LEVELS.put(ERROR_MESSAGE, "Error");
        MESSAGE_LEVELS.put(NO_MESSAGES, "None");
    }
    ...
    public static void uiMessage(Shell shell, String message, String title, WorkflowProject project,
        ...
        if (sendMessage)
            PluginUtil.sendError(null, message);
    }
    ...
    public static void uiMessage(Shell shell, Throwable t, String message, String title,
        ...
        if (sendMessage)
            PluginUtil.sendError(t, message);
    }
    ...
    public static boolean isConnectionException(Exception ex) {
        ...
        if (userMsg.indexOf("ORA-01017") >= 0)
            return true;
        return userMsg.indexOf("Network Adapter could not establish the connection") >= 0;
    }

    public static boolean isDataIntegrityException(Exception ex) {
        String userMsg = getUserMessage(ex);
        return userMsg.indexOf("ORA-02292") >= 0
