...
public class MdwPreferencePage extends PreferencePage implements PreferenceConstants {
    ...
    protected Control createContents(Composite parent) {
        ...
        List<String> reportingLevels = new ArrayList<>();
    ...
    protected void storeValues() {
        ...
        int level = Integer.parseInt(selectedLevel.substring(0, selectedLevel.indexOf('-') - 1));
        store.setValue(PREFS_MDW_REPORTING_LEVEL, level);
    ...
    protected void initializeValues() {
        ...
        mdwReportingLevelCombo.setText(reportingLevel + " - "
                + PluginMessages.MESSAGE_LEVELS.get(reportingLevel));
    ...
    protected void initializeFromDefaults() {
        ...
        mdwReportingLevelCombo
                .setText(PluginMessages.MESSAGE_LEVELS.get(defaultReportingLevel));
