...
public class ServerConsoleSettings implements PreferenceConstants {
    ...
    public void initialize() {
        ...
        String clintShell = store.getString(PREFS_SERVER_CLIENT_SHELL);
        if (clintShell == null || clintShell.isEmpty())
            clintShell = store.getDefaultString(PREFS_SERVER_CLIENT_SHELL);
        setClientShell(ClientShell.valueOf(clintShell));
