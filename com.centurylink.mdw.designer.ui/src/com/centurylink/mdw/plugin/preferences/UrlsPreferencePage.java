...
public class UrlsPreferencePage extends PreferencePage implements PreferenceConstants {
    ...
    private Text mdwCentralUrlTextField;
    ...
    protected Control createContents(Composite parent) {
        ...
        //mdw central url
        createLabel(parent, "MDW Central URL:", 1);
        mdwCentralUrlTextField = createTextField(parent, 330, 2);
        mdwCentralUrlTextField.addModifyListener(new ModifyListener() {
    ...
    protected void storeValues() {
        ...
        store.setValue(PREFS_MDW_CENTRAL_URL, mdwCentralUrlTextField.getText().trim());
    ...
    protected void initializeValues() {
        ...
        mdwCentralUrlTextField.setText(store.getString(PREFS_MDW_CENTRAL_URL));
    ...
    protected void initializeFromDefaults() {
        ...
        mdwCentralUrlTextField.setText(store.getDefaultString(PREFS_MDW_CENTRAL_URL));
    ...
    public boolean validate() {
        ...
        if (!checkUrl(mdwCentralUrlTextField.getText().trim())) {
            setErrorMessage("Invalid MDW Central URL.");
            setValid(false);
            return false;
        }
