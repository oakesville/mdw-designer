...
public class ProcessLaunchMainTab extends AbstractLaunchConfigurationTab {
    ...
    public void setDefaults(ILaunchConfigurationWorkingCopy launchConfig) {
        launchConfig.setAttribute(ProcessLaunchConfiguration.MASTER_REQUEST_ID,
                getMasterRequestId());
        launchConfig.setAttribute(ProcessLaunchConfiguration.OWNER, DESIGNER);
    ...
    protected void createWorkflowProjectSection(Composite parent) {
        ...
        for (WorkflowProject wfProject : workflowProjects) {
            workflowProjectCombo.add(wfProject.getName());
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    AppSummary appSummary = designerProxy.retrieveAppSummary(true);
                    if (appSummary == null) {
