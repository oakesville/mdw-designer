...
public class JdbcDataSource {
    ...
    public static final String DEFAULT_JDBC_URL = "jdbc:oracle:thin:@localhost:1594:mdwdev";
    public static final String DEFAULT_DB_USER = "mdw";
    public static final String DEFAULT_DB_USER_OLD = "mdw";
    public static final String DEFAULT_DB_PASSWORD = "mdw";
