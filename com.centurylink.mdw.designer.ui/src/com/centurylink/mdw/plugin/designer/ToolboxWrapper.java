...
public class ToolboxWrapper extends DesignerPanelWrapper
    ...
    private Map<String, List<ActivityImpl>> projectDirtyImpls = new HashMap<>();
    ...
    private Menu buildPopupMenu() {
        ...
        // view impl source
        if (toolboxSelection != null && !toolboxSelection.isPseudoProcessActivity()) {
