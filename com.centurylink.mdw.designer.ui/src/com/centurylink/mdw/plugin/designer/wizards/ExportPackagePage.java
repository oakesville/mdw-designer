...
public class ExportPackagePage extends ImportExportPage {
    ...
    private void createFormatControls(Composite parent, int ncol) {
        ...
        if (exportJson && exportZip) {
            prefsStore.setValue(PreferenceConstants.PREFS_EXPORT_JSON_FORMAT, true);
            prefsStore.setValue(PreferenceConstants.PREFS_EXPORT_ZIP_FORMAT, false);
        }
        else {
