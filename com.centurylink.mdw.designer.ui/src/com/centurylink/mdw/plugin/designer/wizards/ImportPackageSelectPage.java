...
public class ImportPackageSelectPage extends WizardPage {
    ...
    private List<File> selectedPackages = new ArrayList<>();
    ...
    private void createUpgradeAssetsComposite(Composite parent) {
        ...
        Link upgradeAssetsLink = new Link(upgradeAssetsComposite, SWT.SINGLE | SWT.LEFT);
    ...
    boolean isPageValid() {
        return error == null && !selectedPackages.isEmpty();
    }
    ...
    class ViewCheckStateProvider implements ICheckStateProvider {
        public boolean isChecked(Object element) {
            if (selectedPackages.contains(element))
                ...
                return !collector.getSelectedDescendantFiles().isEmpty();
            }
    ...
    private class FileCollector {
        ...
        private void collect() {
            descendantFiles = new ArrayList<>();
            selectedDescendantFiles = new ArrayList<>();
