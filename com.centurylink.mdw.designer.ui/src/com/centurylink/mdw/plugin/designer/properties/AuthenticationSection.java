...
public class AuthenticationSection extends DesignSection implements IFilter {
    @Override
    public boolean selectForSection(PropertyEditor propertyEditor) {
        return PropertyEditor.SECTION_AUTHENTICATION.equals(propertyEditor.getSection());
    }
    ...
    public boolean select(Object toTest) {
        ...
        for (PropertyEditor propertyEditor : propEditorList) {
            if (PropertyEditor.SECTION_AUTHENTICATION.equals(propertyEditor.getSection()))
                return true;
        }
