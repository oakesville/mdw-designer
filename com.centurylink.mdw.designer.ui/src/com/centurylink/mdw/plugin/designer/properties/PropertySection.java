...
public class PropertySection
    ...
    private Composite createComposite(Composite parent) {
        Composite lComposite = new Composite(parent, SWT.NULL);
        // create the grid layout
        GridLayout gl = new GridLayout();
        gl.numColumns = PropertyEditor.COLUMNS;
        gl.marginTop = 6;
        gl.marginLeft = 3;
        lComposite.setLayout(gl);
        return lComposite;
    }
    ...
    protected Map<String, String> getOverrideAttributes() {
        Map<String, String> overrideAttrs = new HashMap<>();
    ...
    protected void flagDirtyTabs() {
        org.eclipse.ui.internal.views.properties.tabbed.view.TabbedPropertyComposite lComposite = (org.eclipse.ui.internal.views.properties.tabbed.view.TabbedPropertyComposite) tabbedPropertySheetPage
                .getControl();
        if (lComposite != null && !lComposite.isDisposed()) {
            org.eclipse.ui.internal.views.properties.tabbed.view.TabbedPropertyList tabs = lComposite
                    .getList();
