...
public class VariablesSection extends PropertySection implements IFilter {
    ...
    private List<ColumnSpec> createColumnSpecs() {
        ...
        for (int i = 0; i < Display.values().length; i++)
            displayColSpec.options[i+1] = Display.values()[i].toString();
    ...
    class VariableLabelProvider extends LabelProvider implements ITableLabelProvider {
        ...
        public String getColumnText(Object element, int columnIndex) {
            ...
            case 4:
                return variableVO.getDisplay() == null ? null : variableVO.getDisplay().toString();
            case 5:
    ...
    class VariableCellModifier extends TableEditor.DefaultCellModifier {
        ...
        public Object getValue(Object element, String property) {
            ...
            case 4:
                Display display = variableVO.getDisplay();
                int idx = 0;
                if (display != null) {
                    for (int i = 0; i < Display.values().length; i++) {
                        if (Display.values()[i] == display) {
                            idx = i + 1;
                            break;
                        }
                    }
        ...
        public void modify(Object element, String property, Object value) {
            ...
            case 4:
                ...
                variableVO.setDisplay(iVal == null || iVal == 0 ? null : Display.values()[iVal - 1]);
                break;
            case 5:
                Integer intVal = null;
                if (value != null) {
        ...
        public boolean canModify(Object element, String property) {
            ...
            if (editable && getColumnIndex(property) == 4) {
                Integer mode = (Integer) getValue(element, "mode");
                if (mode == null || !(mode == VariableVO.CAT_INPUT || mode == VariableVO.CAT_INOUT))
                    return false;
            }
            return editable;
        }
