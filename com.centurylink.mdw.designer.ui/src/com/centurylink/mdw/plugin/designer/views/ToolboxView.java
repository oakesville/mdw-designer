...
public class ToolboxView extends ViewPart
    ...
    private static final String MSG_SAVE = "Please Save";
    ...
    public void handleFilter() {
        if (isDirty()) {
            MessageDialog.openWarning(getSite().getShell(), MSG_SAVE,
    ...
    public void handleSave() {
        ...
        if (save) {
            ...
            List<String> dirtyImplNames = new ArrayList<>();
    ...
    class ProcessEditorListener extends WorkflowEditorPartListener {
        ...
        public void hidden(WorkflowElementEditor editor) {
            ...
            ToolboxWrapper lToolboxWrapper = ToolboxWrapper.getInstance();
            if (lToolboxWrapper.getFlowchartPage() != null) {
                lToolboxWrapper.setFlowchartPage(null);
                lToolboxWrapper.getSelectionProvider().clearSelection();

                setInput(lToolboxWrapper);
            }
        ...
        private void updateToolboxWrapper(ProcessEditor editor) {
            ToolboxWrapper lToolboxWrapper = ToolboxWrapper.getInstance();
            lToolboxWrapper.setFlowchartPage(editor.getProcessCanvasWrapper().getFlowchartPage());
            lToolboxWrapper.setProcess((WorkflowProcess) editor.getElement());
            setInput(lToolboxWrapper);
        }
    }
}