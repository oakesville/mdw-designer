...
public class CacheRefresh {
    private static final String REFRESH_CACHES = "Refresh Caches";
                ...
                DesignerRunner designerRunner = new DesignerRunner(progressMsg, errorMsg, workflowProject) {
                    public void perform()
                        ...
                        try {
                            ...
                            PluginMessages.uiError(ex, ex.getMessage(), REFRESH_CACHES,
                                    workflowProject);
                        }
                    }
                };
                ...
                if (refreshStatusMessage == null) {
                    PluginMessages.uiError(
                            workflowProject.getName()
                                    ...
                                    REFRESH_CACHES, workflowProject);
                }
        ...
        try {
            ...
            if (!silent) {
                ...
                PluginMessages.uiMessage(workflowProject.getName() + " Refresh Caches:\n" + message,
                        REFRESH_CACHES, workflowProject, PluginMessages.INFO_MESSAGE);
            }
        }
        catch (Exception ex) {
