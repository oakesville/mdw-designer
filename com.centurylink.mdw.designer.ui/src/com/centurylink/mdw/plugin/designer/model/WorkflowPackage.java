...
public class WorkflowPackage extends WorkflowElement
    ...
    public boolean hasDescendantPackageVersions() {
        return descendantPackageVersions != null && !descendantPackageVersions.isEmpty();
    }

    public void addDescendantPackageVersion(WorkflowPackage packageVersion) {
        if (descendantPackageVersions == null)
            descendantPackageVersions = new ArrayList<>();
    ...
    private List<WorkflowProcess> processes = new ArrayList<>();
    ...
    public boolean hasTaskTemplates() {
        return taskTemplates != null && !taskTemplates.isEmpty();
    }
    ...
    private List<ActivityImpl> activityImpls = new ArrayList<>();
    ...
    public boolean hasActivityImpls() {
        return activityImpls != null && !activityImpls.isEmpty();
    }
    ...
    private List<WorkflowAsset> assets = new ArrayList<>();
    ...
    public boolean hasChildFolders() {
        return childFolders != null && !childFolders.isEmpty();
    }
    ...
    public IFile getMetaFile() {
        IFile metaFile = getMetaFolder().getFile("package.yaml");
        if (!metaFile.exists()) {
            metaFile = getMetaFolder().getFile("package.json");
            if (!metaFile.exists())
    ...
    public List<WorkflowPackage> getAllPackageVersions() {
        List<WorkflowPackage> allVersions = new ArrayList<>();
