...
public class PluginDataAccess {
    private static final String RETRIEVE_PROC_INST = "Retrieve Process Instance";
    ...
    public ProcessInstanceVO getProcessInstance(Long processInstanceId) {
        try {
            ...
            MessageDialog.openError(MdwPlugin.getShell(), RETRIEVE_PROC_INST,
            ...
            if (workflowProject.isFilePersist()) {
                ...
                PluginMessages.uiError(ex, RETRIEVE_PROC_INST, workflowProject);
            }
            return null;
        }
        catch (Exception ex) {
    ...
    public void auditLog(Action action, Entity entity, Long entityId, String comments)
        ...
        if (!workflowProject.checkRequiredVersion(6, 1, 1)) {
            UserActionVO userAction = new UserActionVO(workflowProject.getUser().getUsername(),
                    action, entity, entityId, comments);
    ...
    public Map<String, List<String>> getTaskVariableMappings() throws DataAccessException {
        Map<String, List<String>> ownerVars = new TreeMap<>(
    ...
    public RuleSetVO loadRuleSet(Long ruleSetId) throws DataAccessException {
