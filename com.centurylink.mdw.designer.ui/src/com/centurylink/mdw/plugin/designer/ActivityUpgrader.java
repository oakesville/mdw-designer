...
public class ActivityUpgrader {
    public static final String INVOKE_SUBPROCESS = "com.centurylink.mdw.workflow.activity.process.InvokeSubProcessActivity";
    public static final String INVOKE_HETERO = "com.centurylink.mdw.workflow.activity.process.InvokeHeterogeneousProcessActivity";
    public static final String AUTOFORM_TASK = "com.centurylink.mdw.workflow.activity.task.AutoFormManualTaskActivity";
    public static final String CUSTOM_TASK = "com.centurylink.mdw.workflow.activity.task.CustomManualTaskActivity";
    public static final String VARIABLE_EVAL = "com.qwest.mdw.workflow.activity.impl.evaluator.VariableValueEvaluator";
    public static final String SCRIPT_EVAL = "com.centurylink.mdw.workflow.activity.script.ScriptEvaluator";
    public static final String OLD_TASK_NOTIFIER = "com.qwest.mdw.workflow.task.observer.TaskEmailNotifier";
    public static final String NEW_TASK_NOTIFIER = "com.centurylink.mdw.workflow.task.notifier.TaskEmailNotifier";
