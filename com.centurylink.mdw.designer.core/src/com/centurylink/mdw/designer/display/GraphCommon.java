...
public abstract class GraphCommon {
    ...
    public abstract ProcessVO getProcessVO();
    ...
    Rectangle parseGeoInfo(String attrvalue) {
        ...
        for (int i=0; i<tmps.length; i++) {
            ...
            if (an.equals("x")) rect.x = Double.valueOf(av).intValue();
            else if (an.equals("y")) rect.y = Double.valueOf(av).intValue();
            else if (an.equals("w")) rect.width = Double.valueOf(av).intValue();
            else if (an.equals("h")) rect.height = Double.valueOf(av).intValue();
        }
        return rect;
    }
