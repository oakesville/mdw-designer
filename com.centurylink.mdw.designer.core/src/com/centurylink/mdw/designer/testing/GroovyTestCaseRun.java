...
public class GroovyTestCaseRun extends TestCaseRun {
    ...
    void startProcess(TestCaseProcess process) throws TestException {
        ...
        try {
            ...
            String response;
            if (server == null) {
                response = dao.launchProcess(vo, getMasterRequestId(), null, params, false,
                        oldNamespaces);
            }
            else {
                ...
                if (restServer.isSchemaVersion61()) {
                    ...
                    String request = restServer.buildLaunchProcessRequest(vo, getMasterRequestId(),
                            null, params, false, oldNamespaces);
    ...
    public JSONObject submitItem(TestCase apiTestCase, TestCaseItem testItem) throws TestException {
        try {
            ...
            nodeRunnerClass.run(apiTestCase, dao, verbose, createReplace);
    ...
    public boolean verifyItem(TestCase testCase, TestCaseItem item) throws TestException {
        try {
            ...
            passed = testCase.getStatus().equalsIgnoreCase(TestCase.STATUS_PASS);
            return passed;
        }
        catch (Exception ex) {
            throw new TestException(ex.getMessage(), ex);
