...
public class TestCase {
    ...
    public static final String LANGUAGE_POSTMAN = "Postman";
    ...
    public TestCase(String prefix, File caseFile) {
        ...
        if (caseFile.isDirectory()) {
            ...
            if (caseFile.getName().endsWith(RuleSetVO.getFileExtension(RuleSetVO.FEATURE)))
                setLanguage(LANGUAGE_GHERKIN);
            else if (caseFile.getName().endsWith(RuleSetVO.getFileExtension(RuleSetVO.POSTMAN)))
                setLanguage(LANGUAGE_POSTMAN);
        }
        this.prefix = prefix;
    }
    ...
    public TestCase(String prefix, RuleSetVO ruleSet) {
        ...
        if (ruleSet.getName().endsWith(RuleSetVO.getFileExtension(RuleSetVO.FEATURE)))
            setLanguage(LANGUAGE_GHERKIN);
        else if (ruleSet.getName().endsWith(RuleSetVO.getFileExtension(RuleSetVO.POSTMAN)))
            setLanguage(LANGUAGE_POSTMAN);
        this.prefix = prefix;
    }
    ...
    public boolean isPostman() {
        return LANGUAGE_POSTMAN.equals(language);
    }
    ...
    public TestCaseItem getTestCaseItem(RuleSetVO ruleset, String method, String itemName)
            throws IOException, JSONException {
        String json = new String(FileHelper.read(ruleset.getRawFile()));
