...
public class DesignerCompatibility implements SchemaTypeTranslator {
     ...
     *
     * @param actionRequestDoc
     *            - New-namespace request doc
    ...
    public String getOldActionRequest(ActionRequestDocument actionRequestDoc) throws XmlException {
        ...
        com.qwest.mdw.services.ActionRequestDocument oldDoc = com.qwest.mdw.services.ActionRequestDocument.Factory
                .parse(actionRequestDoc.xmlText(), reverseOpts);
        XmlOptions printOpts = new XmlOptions().setSavePrettyPrint().setSavePrettyPrintIndent(2);
        return oldDoc.xmlText(printOpts);
    }

    public String getOldProcessDefinition(ProcessDefinitionDocument procDefDoc)
            throws XmlException {
        // reparse with reverse namespaces
        XmlOptions reverseOpts = Compatibility.getReverseNamespaceOptions();
        com.qwest.mdw.xmlSchema.ProcessDefinitionDocument oldDoc = com.qwest.mdw.xmlSchema.ProcessDefinitionDocument.Factory
                .parse(procDefDoc.xmlText(), reverseOpts);
        XmlOptions printOpts = new XmlOptions().setSavePrettyPrint().setSavePrettyPrintIndent(2);
        return oldDoc.xmlText(printOpts);
    }
