...
public class ServerAccessRest {
    ...
    public static final String TOKEN_EXPIRED= "JWT token has been expired";
    ...
    public boolean isTokenExpired(IOException ex) {
        String msg = ex.getMessage();
        if (ex.getCause() != null)
            msg = ex.getCause().getMessage();
        return server.getJwtToken() != null && msg.indexOf("401") > -1;
    }
}
